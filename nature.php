...
// Utiliser directement toutes les images disponibles
$photos = [
    [
        ...
        <div class="container">
            <div class="nature-gallery">
                <?php if (!empty($photos)): ?>
                    ...
                    <div class="nature-card fade-in-up" data-category="<?= htmlspecialchars($photo['category'] ?? 'Nature') ?>">
                        <div class="nature-image-container">
                            <img src="assets/images/<?= htmlspecialchars($photo['image']) ?>" alt="<?= htmlspecialchars($photo['title']) ?>" class="nature-image" onerror="this.src='assets/images/nature.jpeg';">
                            ...
                            <div class="nature-overlay">
                                ...
                                <div class="nature-meta">
                                    <span class="nature-category"><?= htmlspecialchars($photo['category'] ?? 'Nature') ?></span>
                                    <span class="nature-date">
                                        <i class="fas fa-calendar"></i>
                                        <?= isset($photo['date_taken']) ? date('d/m/Y', strtotime($photo['date_taken'])) : date('d/m/Y') ?>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p style="text-align: center; color: var(--gray-600); font-size: 1.1rem;">Aucune photo disponible pour le moment.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
